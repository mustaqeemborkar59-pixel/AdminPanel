                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    displayAddress && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ {"00297a05172ea2864074da52ab33dfd029b3e8f318":"getOrdersFromWooCommerce","601f181b794cd63f50dfa4b14a542bb6ac1499894b":"updateOrderStatusInWooCommerce"} */ __turbopack_context__.s({
...
function OrdersPage() {
    ...
    const generatePdf = (ordersToExport)=>{
        ...
        ordersToExport.forEach((originalOrder, index)=>{
            ...
            doc.text('INVOICE', pageWidth - margin, 30, {
                align: 'right'
            });
            doc.setFontSize(10);
            ...
            doc.setFontSize(10);
            doc.setFont('helvetica', 'bold');
            doc.text('Order ID:', pageWidth - 60, 45, {
                align: 'left'
            });
            doc.text('Date:', pageWidth - 60, 52, {
                align: 'left'
            });
            ...
            doc.setFont('helvetica', 'normal');
            doc.text(order.id, pageWidth - margin, 45, {
                align: 'right'
            });
            doc.text(formatDateInIST(order.timestamp), pageWidth - margin, 52, {
                align: 'right'
            });
            doc.text(order.status, pageWidth - margin, 59, {
                align: 'right'
            });
            // Line Separator
            ...
            doc.text(`₹${order.subTotal.toFixed(2)}`, textX, totalY, {
                align: 'right'
            });
            doc.text(`Tax (${(order.subTotal > 0 ? order.taxAmount / order.subTotal * 100 : 0).toFixed(0)}%):`, subtotalX, totalY + 7, {
                align: 'right'
            });
            doc.text(`₹${order.taxAmount.toFixed(2)}`, textX, totalY + 7, {
                align: 'right'
            });
            ...
            doc.text(`₹${order.totalAmount.toFixed(2)}`, textX, totalY + 18, {
                align: 'right'
            });
            // Footer
            doc.setFontSize(10);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__54ac0077._.js.map