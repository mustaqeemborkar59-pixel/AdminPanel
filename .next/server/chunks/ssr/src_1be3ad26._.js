...
function VendorsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchVendors = async ()=>{
            setIsLoading(true);
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$auth$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getVendorsFromFirestore"])();
    ...
    const handleAddVendor = async (newVendorData)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$auth$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveVendorToFirestore"])(newVendorData);
        if (result.success) {
            toast({
                title: "Vendor Added",
    ...
    const handleEditVendor = async (updatedVendor)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$auth$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveVendorToFirestore"])(vendorData, id);
        if (result.success) {
            toast({
    ...
    const handleDeleteVendor = async (vendorId)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$auth$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteVendorFromFirestore"])(vendorId);
        if (result.success) {
            toast({
...
//# sourceMappingURL=src_1be3ad26._.js.map