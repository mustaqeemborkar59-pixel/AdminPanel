...
function DashboardContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (vendorFilteredOrders.length > 0) {
            ...
            if (fromDate && toDate) {
                ...
                const startDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startOfDay"])(fromDate);
                const endDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$endOfDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["endOfDay"])(toDate);
                ...
                const ordersFor25th = vendorFilteredOrders.filter((o)=>o.paymentDate && new Date(o.paymentDate).getDate() === 25).map((o)=>({
                        id: o.id,
                        payment: o.paymentDate,
                        created: o.timestamp
                    }));
            ...
            setWeeklyOrderData(Array(7).fill(0).map((_, i)=>({
                    name: daysOfWeek[i],
                    orders: 0
                })));
            setSalesDetailsData([]);
    ...
    if (isSuperAdmin) {
        allStatsCards.push(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(StatsCard, {
            title: "Admins",
