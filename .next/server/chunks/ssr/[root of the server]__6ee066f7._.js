...
"[project]/src/app/vendors/actions.ts [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
function OrdersPage() {
    const { user, userProfile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$app$2d$content$2d$wrapper$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAppContext"])(); // Get user profile from context
    ...
    const filteredOrders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        let filtered = vendorFilteredOrders.filter((order)=>statusFilter === 'all' || order.status === statusFilter).filter((order)=>{
        ...
        }).filter((order)=>order.items.length > 0).filter((order)=>{
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6ee066f7._.js.map