...
function OrdersPage() {
    ...
    const exportToPDF = ()=>{
        ...
        const tableData = orders.filter((o)=>selectedOrders.has(o.id)).map((o)=>[
                o.id,
                o.customerName,
    ...
    const exportToExcel = ()=>{
        ...
        const worksheet = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["utils"].json_to_sheet(selected.map((o)=>({
                'Order ID': o.id,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["writeFile"])(workbook, "selected_orders.xlsx");
    };
