...
"[project]/src/firebase/error-emitter.ts (client reference/proxy) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/firebase/error-emitter.ts (client reference/proxy)": ((__turbopack_context__) => {
"use strict";
...
var { g: global, __dirname } = __turbopack_context__;
{
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$error$2d$emitter$2e$ts__$28$client__reference$2f$proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/firebase/error-emitter.ts (client reference/proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$error$2d$emitter$2e$ts__$28$client__reference$2f$proxy$29$__ = __turbopack_context__.i("[project]/src/firebase/error-emitter.ts (client reference/proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$error$2d$emitter$2e$ts__$28$client__reference$2f$proxy$29$__);
}}),
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ createUserProfile(details) {
    ...
    try {
        const userRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${details.uid}`);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["setDoc"])(userRef, userProfile, {
            merge: true
        }).catch((error)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$error$2d$emitter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["errorEmitter"].emit('permission-error', permissionError);
        });
        return {
            success: true
        };
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getUserProfile(uid) {
    const { firestore } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["initializeFirebase"])();
    try {
        const userRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${uid}`);
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getAllUsers() {
    const { firestore } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["initializeFirebase"])();
    try {
        const usersRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["collection"])(firestore, 'users');
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ updateUserRole(userId, role, vendorCode) {
    const { firestore } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["initializeFirebase"])();
    try {
        const userRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${userId}`);
        const updates = {
            role
        };
        if (role === 'vendor') {
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ saveCompanyDetailsToRTDB(details) {
    ...
    const { rtdb } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["initializeFirebase"])();
    if (!rtdb) {
        return {
            success: false,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e2bf9c65._.js.map