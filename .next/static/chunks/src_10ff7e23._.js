(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_10ff7e23._.js", {
...
"[project]/src/app/vendors/actions.ts [app-client] (ecmascript)": (function(__turbopack_context__) {
...
function OrdersPage() {
    _s();
    const { user, userProfile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$app$2d$content$2d$wrapper$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppContext"])(); // Get user profile from context
    ...
    const isSuperAdmin = user?.email === ("TURBOPACK compile-time value", "yasirsolkar28@gmail.com");
    ...
    const filteredOrders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OrdersPage.useMemo[filteredOrders]": ()=>{
            ...
            if (currentVendorCode) {
                vendorFilteredOrders = orders.map({
                    "OrdersPage.useMemo[filteredOrders]": (order)=>{
                        const vendorItems = order.items.filter({
                            "OrdersPage.useMemo[filteredOrders].vendorItems": (item)=>item.vendorName === currentVendorCode
                        }["OrdersPage.useMemo[filteredOrders].vendorItems"]);
            ...
            let filtered = vendorFilteredOrders.filter({
...
_s(OrdersPage, "JHOUAry7biuJI5fF5nXh57m6h9s=", false, function() {
    return [
...
//# sourceMappingURL=src_10ff7e23._.js.map