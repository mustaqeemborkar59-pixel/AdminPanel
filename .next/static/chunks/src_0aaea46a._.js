(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_0aaea46a._.js", {
...
function AppSidebarNav() {
    ...
    const navItemsToDisplay = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "AppSidebarNav.useMemo[navItemsToDisplay]": ()=>{
            if (!mounted) {
                return [];
            }
            ...
            if (authLoading) {
                ...
                return authNavItems.filter({
                    "AppSidebarNav.useMemo[navItemsToDisplay]": (item)=>item.guestOnly
                }["AppSidebarNav.useMemo[navItemsToDisplay]"]);
            }
            if (user) {
                return [
...
_s(AppSidebarNav, "xBOIHQpf/VaQrs1WOQ3jlvJbCbo=", false, function() {
    return [
...
//# sourceMappingURL=src_0aaea46a._.js.map