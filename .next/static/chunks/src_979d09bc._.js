(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_979d09bc._.js", {
...
function OrderListItem({ order, onUpdateStatus, value, isSelected, onToggleSelect, formatDate }) {
    ...
    const [pincode, setPincode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(order.pincode || '');
    const [address1, setAddress1] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(order.billingAddress?.split(',')[0] || '');
...
_s(OrderListItem, "B03C/ViDrKfbeYyO9SalUIBUoxY=", false, function() {
    return [
            ...
            const fetchOrders = {
                "OrdersPage.useEffect.fetchOrders": async ()=>{
                    ...
                    if (result.success && result.data) {
                        ...
                        const vendors = new Set(result.data.flatMap({
                            "OrdersPage.useEffect.fetchOrders": (order)=>order.items.map({
                                    "OrdersPage.useEffect.fetchOrders": (item)=>item.vendorName
                                }["OrdersPage.useEffect.fetchOrders"]).filter(Boolean)
            ...
            let filtered = orders.filter({
                ...
                "OrdersPage.useMemo[filteredOrders].filtered": (order)=>{
                    ...
                    return order.items.some({
                        "OrdersPage.useMemo[filteredOrders].filtered": (item)=>item.vendorName === vendorFilter
                ...
                "OrdersPage.useMemo[filteredOrders].filtered": (order)=>{
                    ...
                    const vendorItems = order.items.filter({
                        "OrdersPage.useMemo[filteredOrders].filtered.vendorItems": (item)=>item.vendorName === vendorFilter
...
_s(OrdersPage, "iDBfgUfIT6zzb5V3XRVjQ8g1188=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
//# sourceMappingURL=src_979d09bc._.js.map