        ...
        "DashboardContent.useEffect": ()=>{
            if (vendorFilteredOrders.length > 0) {
                ...
                const validOrdersForRevenue = vendorFilteredOrders.filter({
                    "DashboardContent.useEffect.validOrdersForRevenue": (order)=>order.paymentDate
                ...
                if (fromDate && toDate) {
                    ...
                    const recentPaidOrders = vendorFilteredOrders.filter({
                        "DashboardContent.useEffect.recentPaidOrders": (order)=>{
                    ...
                    }["DashboardContent.useEffect.recentPaidOrders"]);
                ...
                setWeeklyOrderData(Array(7).fill(0).map({
                    "DashboardContent.useEffect": (_, i)=>({
                            name: daysOfWeek[i],
                            orders: 0
                        })
                }["DashboardContent.useEffect"]));
