...
import { app } from '@/lib/firebase'; // Assuming app is exported for getAuth
...
export function AppContentWrapper({ children }: AppContentWrapperProps) {
  ...
  if (isAuthPage && !user) {
    return <>{children}</>; // Render login/signup pages directly
  }
  ...
  // Fallback loader during redirection initiated by useEffect
